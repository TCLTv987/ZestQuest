...
export const FusionCard: React.FC<FusionCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`relative w-full max-w-[320px] aspect-[3/4.5] rounded-3xl cursor-pointer select-none overflow-hidden transition-all duration-300 ${
    ...
    >
      ...
      <div className="relative h-full flex flex-col justify-between p-5 text-white" style={{ transform: "translateZ(30px)" }}>
        {/* Header line */}
          ...
          {pokemon.isFused ? (
            ...
            >
              ...
              <img
                ...
                className="w-full h-full object-contain filter drop-shadow-[0_8px_16px_rgba(0,0,0,0.3)] group-hover:scale-105 transition-transform duration-300"
              />
            </motion.div>
          )}
        </div>
